/*
 * File: d:\works\punsh\src\components\imageView.vue
 * Created Date: 2018-04-11 8:57:23
 * Author: 魏巍
 * -----
 * Last Modified: 魏巍
 * Modified By: 2018-04-11 9:15:17
 * -----
 * Copyright (c) 2018 魏巍
 * ------
...
<template>
    <div>
        ...
        <img :src="item" data-preview-src="" data-preview-group="1" 
            v-for="(item,index) in list" :key="index" v-if="list"/>
    </div>
</template>
