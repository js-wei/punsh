...
<template>
    <div class="index">
        ...
        <scroller :on-refresh="refresh" :on-infinite="infinite" 
            height="90%" ref="my_scroller" class="my-scroller" style="padding-top:44px;">
    ...
    return {
      ...
      mediaList: [
        ...
        },
        {
          ...
          image:
            "https://t10.baidu.com/it/u=1404838365,1237784769&fm=175&app=25&f=JPEG?w=500&h=332&s=9270F4A442E39CE2422131360300D04C",
          description:
